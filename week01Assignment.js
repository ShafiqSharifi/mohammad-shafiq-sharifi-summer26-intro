...
const firstName = "Mohammad Shafiq";
const lastName = "Sharifi";
...
const floatingPoint = 45.5;
const integer = 28;
const negative = -250;
const bigNumber = 92560000000095291;

// I understand the purpose of this question. It is showing that JavaScript's Number type cannot accurately represent every very large integer. Once a number exceeds Number.MAX_SAFE_INTEGER, JavaScript may round the value or lose precision, so BigInt should be used for larger integers.
...
const wasLessonOneFun = true;
const isAssigmentHard = false;

console.log("Q3: The variable I made true is: ", wasLessonOneFun);
console.log("Q3: The variable I made false is: ", isAssigmentHard);
...
const firstHelloString = "Hello, my name is " + firstName + " " + lastName + " and I was born in " + country;
const secondHelloString = `Hello, my name is ${firstName} ${lastName} and I was born in ${country}`;
...
const lastInitial = firstName.slice(-1);
...
const answer = integer > 10 ? true : false;

//challenge with ternari
// const stretchAnswer = integer < 10 ? "less than" : integer === 10 ? "equal to" : "greater than";
...
let exampleNum = 23.5671;
console.log("Q9 exampleNum before round: ", exampleNum);
console.log("Q9 exampleNum after round: ", exampleNum.toFixed(2));
